        ...
        {userLoading ? (
          ...
          <div className="flex px-6 lg:gap-16 justify-center items-start h-max">
            ...
            <div className="inline-flex flex-col items-start gap-2">
              <h3 className="text-H4-03 md:text-H3-03 text-cod-gray-cg-500 w-[90%] mx-auto lg:mx-0  max-w-[543px] text-center lg:text-left">
                Hi, Welcome to Poultry Collective
              </h3>

              <p className="text-BC-03 md:text-H5-03 font-normal text-cod-gray-cg-400 w-[90%] mx-auto lg:mx-0  max-w-[453px] text-center lg:text-left">
                Sign in with Poultry Collective and start buying and selling
                fresh poultry produce.
              </p>

              <form
                className="w-[90%] mx-auto lg:w-[400px] flex flex-col items-start gap-6 pt-5 lg:mx-0"
              ...
              <div className="w-[90%] mx-auto lg:mx-0 lg:w-[400px] flex flex-col items-center justify-start gap-8 mt-6">
