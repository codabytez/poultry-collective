        ...
        {userLoading ? (
          ...
          <div className="flex px-6 lg:gap-16 justify-center items-start h-max">
            ...
            <div className="inline-flex flex-col items-start gap-2">
              ...
              <form
                className="w-[90%] mx-auto lg:w-[400px] flex flex-col items-start gap-6 pt-5"
              ...
              <div className="w-[90%] mx-auto lg:w-[400px] flex flex-col items-center justify-start gap-8 mt-6">
